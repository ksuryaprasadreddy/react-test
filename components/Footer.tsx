...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#2F2B3D] text-white px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-2">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-[#363248] rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#7367F0]"
                />
                <Button
                  type="submit"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <Link
                href="#"
                className="flex items-center gap-3 px-4 py-2 bg-[#363248] rounded hover:bg-[#363248]/80 transition-colors"
              >
              ...
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6">
                  <path
                    fill="currentColor"
                    d="M3,20.5C3,20.5 6.5,20 6.5,20C8,20 8,18.5 8,18.5V3.5C8,3.5 8,2 6.5,2C6.5,2 3,1.5 3,1.5V20.5M16,20.5C16,20.5 19.5,20 19.5,20C21,20 21,18.5 21,18.5V3.5C21,3.5 21,2 19.5,2C19.5,2 16,1.5 16,1.5V20.5M16,7L21,7V5L16,5V7M3,7L8,7V5L3,5V7Z"
                  />
                </svg>
                <div className="text-sm">
                  <div className="opacity-70">Download on the</div>
